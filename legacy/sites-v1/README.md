...
The canonical product brief and decisions live in Obsidian: [Personal Site](</Users/chadwick.poon/Library/Mobile Documents/iCloud~md~obsidian/Documents/alan-skills/Knowledge Base/20 Personal/Projects/Personal Site/Personal Site.md>). Start there for the selected Neal.fun gallery and Duolingo-style character welcome, rejected visual references, the content map, and open prototype choices. The brief distinguishes Chadwick's confirmed decisions from proposed interactions.
