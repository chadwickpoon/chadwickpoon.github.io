...
- The site is static HTML, CSS, and JavaScript with no server or database. Do not introduce a framework without a concrete need.
...
- GitHub Pages currently publishes origin/master. A push to that branch can change the live website while DNS still points to GitHub.
